...
!Copyright (C)  2025 A.J. Koning
  subroutine write_exfor(indent,author,year,subentry,reaction)
!
! +---------------------------------------------------------------------
! | Author: Arjan Koning
! | Date  : May 20, 2023
! | Task  : Write output block for specific EXFOR information
! +---------------------------------------------------------------------
!
! ****************** Declarations **************************************
!
...
!
  id2 = indent + 2
  call write_char(indent,'exfor','')
  call write_char(id2,'author',author)
  call write_integer(id2,'year',year)
  call write_char(id2,'subentry',trim(subentry))
  call write_char(id2,'X4 reaction',trim(reaction))
  call write_char(id2,'X4 source','IAEA-NDS C5 file, database version 2023-08-08')
  call write_char(id2,'X4 link','https://nds.iaea.org/EXFOR/'//trim(subentry))
  return
  end
