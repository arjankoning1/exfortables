...
unalias -a
echo
echo "       EXFORTABLES installation (Version December 29 2024) (C) Copyright 2024 Arjan Koning All Rights Reserved"
echo
echo " Two ways to use this script:"
echo
echo " install_exfortables.bash 'Arjan Koning'"
echo "     Replace  Arjan Koning by your own name"
echo
echo " or"
echo
echo " install_exfortables.bash"
